...
검증 대상은 토큰 생성·만료·변조, refresh token 교체, 소셜 로그인 정보, 메모 소유권, 이미지 형식·크기. PostgreSQL 17 격리 환경에서도 API 19개 항목과 동시 refresh 요청 검증 완료. 운영 요청 횟수 제한, 실기기 로그인·알림은 별도 확인 대상. [운영 적용·검증 범위](docs/auth-and-access.md#운영-적용과-검증--2026-09-22)
